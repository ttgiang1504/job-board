<x-layout>
    ...
    <x-card class="py-8 px-16">
        <form action="{{ route('auth.store') }}" method="POST">
            ...
            <x-button class="w-full mb-3"> Login </x-button>
            <p class="text-sm font-medium">Create your account?<a class=" ml-2 text-indigo-600 hover:underline" href="{{ route('user.register')}}">Register</a></p>
    </x-card>
</x-layout>