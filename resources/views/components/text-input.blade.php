<div class="relative">
    ...
    @endif
    <input x-ref="input-{{ $name }}" type="{{ $type }}" value="{{$value}}" name="{{$name}}" id="{{$name}}" placeholder="{{$placeholder}}"
    class="pr-8 w-full rounded-md border-0 py-1.5 px-2.5 text-sm ring-1
